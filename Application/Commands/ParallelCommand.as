package Application.Commands {
    ...
    public class ParallelCommand extends EventDispatcher implements ICommand {
        ...
        public function execute():void {
            ...
            if (_delay > 0) {
                var timer:flash.utils.Timer = new flash.utils.Timer(int(1000 * _delay), 1);
                timer.addEventListener(flash.events.TimerEvent.TIMER_COMPLETE, onDelayComplete);
                timer.start();
            } else {
                startAllCommands();
            }
         ...
         */
        private function onDelayComplete(e:flash.events.TimerEvent):void {
            var timer:flash.utils.Timer = e.target as flash.utils.Timer;
            timer.removeEventListener(flash.events.TimerEvent.TIMER_COMPLETE, onDelayComplete);
            startAllCommands();
        }
