...
/**
* ASSEMBLY v1.1 (DisplayName Uniqueness Support)
*
...
* │   Name Uniqueness API:                                                  │
* │                                                                         │
* │   hasAtomWithName(name, ?excludeId) → Bool                              │
* │   ─────────────────────────────────────                                 │
* │   Checks if any internal atom has the specified displayName.            │
* │   Used by NodeView inline editor to validate rename operations.         │
* │                                                                         │
* │   Parameters:                                                           │
* │   - name       : String - The display name to check                     │
* │   - excludeId  : String - Optional ID to exclude (for rename)           │
* │                                                                         │
* │   Returns:                                                              │
* │   - true  if name is already taken                                      │
* │   - false if name is available                                          │
* │                                                                         │
* │   getAllAtomNames() → Array<String>                                     │
* │   ───────────────────────────────                                       │
* │   Returns array of all internal atom displayNames.                      │
* │   Useful for autocomplete, debugging, and UI lists.                     │
* │                                                                         │
* │   getAtomByDisplayName(name) → Atom                                     │
* │   ──────────────────────────────────────                                │
* │   Finds atom by its displayName. Returns null if not found.             │
* │   Useful for programmatic access by human-readable name.                │
* │                                                                         │
* └─────────────────────────────────────────────────────────────────────────┘
*
* Usage Example:
