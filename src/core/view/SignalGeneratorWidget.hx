 ...
 * Interactive control panel for the Signal Generator Atom.
 *
 * Architecture: "ATOM IS DATABANK & COMPUTE CORE"
 *
 * SignalGeneratorWidget is the FACE of SignalGeneratorAtom.
 *
 * ┌─────────────────────────────────────────────────────────────────────────┐
 ...
 * │   Widget WRITES to contacts on user interaction                         │
 * │   Widget auto-syncs with contact changes                                │
 * │                                                                         │
 * └─────────────────────────────────────────────────────────────────────────┘
 *
 * Controls:
 * 1. Frequency and Quantum sliders (visual + drag)
 * 2. +/- buttons for fine-tuning
 * 3. Mode toggle buttons
 * 4. Activity indicator (LED)
 * 5. Current value and statistics display
 */
class SignalGeneratorWidget extends DeviceView
{
    ...
    private function createModeButtons(yPos:Float):Void 
    {
        ...
        for (i in 0...modes.length) 
        {
            ...
            // Store mode ID in the sprite's name property for retrieval on click
    ...
    {
        // Adaptive step: higher frequency = larger step
...
// =============================================================================
// HELPER CLASS: SLIDER CONTROL
// =============================================================================
/**
 * Simple slider for parameter control.
...
class SliderControl extends Sprite 
{
    ...
    private function buildUI():Void 
    {
        ...
        // Handle (optional, currently just a clickable track)
        buttonMode = true;
        useHandCursor = true;
    ...
    private function updateFromMouse():Void 
    {
        ...
        if (logarithmic) 
        {
            // Logarithmic scale for frequency mapping
