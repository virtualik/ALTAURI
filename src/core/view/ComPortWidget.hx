 ...
 *
 * ComPortWidget is the FACE of ComPortAtom.
 *
 * ┌─────────────────────────────────────────────────────────────────────────┐
 * │   ComPortWidget                                                         │
 * │                                                                         │
 ...
 *
 * Controls:
 * 1. Port Name & Baud Rate inputs (editable TextFields)
 * 2. OPEN / CLOSE buttons for connection management
 * 3. TX Input & SEND button for data transmission
 * 4. DTR Toggle switch
 * 5. RX Data display area (multiline, auto-scroll)
 * 6. LED indicators: Connection status, RX/TX/Error pulses
 */
