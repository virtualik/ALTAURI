// ============================================================================
//  WebSocketClientWidget.hx
//  Cross-platform interactive control panel for WebSocketClientAtom.
//
 ...
 * Interactive control panel for WebSocketClientAtom.
 *
 ...
 */
class WebSocketClientWidget extends DeviceView
{
    // =========================================================================
    // LAYOUT CONSTANTS
    // =========================================================================
    ...
    // =========================================================================
    /**
     * Create a new WebSocketClientWidget for the given atom.
     *
     * @param atom The WebSocketClientAtom instance this widget represents.
     */
    ...
    private function buildUI():Void
    {
        ...
        _titleLabel.text = "  WEBSOCKET CLIENT";
