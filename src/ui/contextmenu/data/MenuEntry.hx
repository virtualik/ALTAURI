...
class MenuEntry
{
	 ...
	 * @param iconId Explicit icon ID (e.g. from Blueprint.iconId). Falls back to typeId if null.
	 * @return MenuEntry configured for atom creation
	 */
	public static function createAtom(typeId:String, displayName:String, ?iconId:String = null):MenuEntry
	{
		var finalIcon = (iconId != null && iconId != "") ? iconId : typeId;
		return new MenuEntry(
			"atom_" + typeId,
			displayName,
			finalIcon,
	 ...
	 * @param iconId Explicit icon ID. Defaults to "default_assembly" if null.
	 * @return MenuEntry configured for assembly creation
	 */
	public static function createAssembly(typeId:String, displayName:String, ?iconId:String = null):MenuEntry
	{
		var finalIcon = (iconId != null && iconId != "") ? iconId : "default_assembly";
		return new MenuEntry(
			"asm_" + typeId,
			displayName,
			finalIcon,
