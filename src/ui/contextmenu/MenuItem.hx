 ...
 * ║                                                                           ║
 * ║  v2.1: Improved grid label display with smaller font and word wrap        ║
 * ║                                                                           ║
 * ║  Architecture:                                                            ║
 * ║  ┌─────────────────────────────────────────────────────────────────────┐  ║
 * ║  │  MenuItem (Sprite)                                                  │  ║
 ...
 * ║  │  │ [Icon] │                                                         │  ║
 * ║  │  └────────┘                                                         │  ║
 * ║  │   Label text (multiline, smaller font)                              │  ║
 * ║  └─────────────────────────────────────────────────────────────────────┘  ║
 * ║                                                                           ║
 * ║  States:                                                                  ║
 ...
 * ║                                                                           ║
 * ╚═══════════════════════════════════════════════════════════════════════════╝
 * MENU ITEM v2.1 (Improved Grid Label Display)
 * Single clickable entry in content panel.
 *
 * v2.1 Changes:
 * - Grid mode label now uses smaller font (9px instead of 10px)
 * - Grid mode label supports multiline (wordWrap = true)
 * - Grid mode label height increased to 25px (from 20px)
 *
...
// Map hash to a nice looking color (avoiding too dark/light)
	...
	private function layoutGrid():Void
	{
		...
		_iconContainer.y = 8; // Slightly higher to make room for label
		_labelField.x = 4;
		_labelField.y = ICON_SIZE + 8;
		_labelField.width = GRID_WIDTH - 8;
		_labelField.height = 22; // Increased from 20px
// v2.1: Smaller font and word wrap for better text fitting
		var fmt = new TextFormat("_sans", 9, COLOR_NORMAL_TEXT, false, null, null, null, null, "center");
