...
/**
 * DevicePanel v3.0 (Dashboard Mode)
 ...
 *
 * v3.0 Changes:
 * - Added Dashboard functionality (multiple devices).
 * - Context Menu (Right-Click) to add devices.
 * - Header buttons: [E] to return to Editor, [C] to clear.
