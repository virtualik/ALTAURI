...
/**
 * DevicePanel v3.2 (Fix Add Device Save)
 * Full-size device display panel inside the Main Window.
 *
 * v3.2 Changes:
 * - FIXED: addDevice() now emits DEVICE_WINDOW_CHANGED to trigger auto-save.
 *
 * DevicePanel v3.1 (State Sync)
 * Full-size device display panel inside the Main Window.
 *
 * ═══════════════════════════════════════════════════════════════════════════
 ...
 * ═══════════════════════════════════════════════════════════════════════════
 *
 * DevicePanel — это встроенная приборная панель (Dashboard) внутри главного окна.
 * Является альтернативой отдельному окну DeviceWindow.
 *
 * ┌─────────────────────────────────────────────────────────────────────────┐
 ...
 *
 * v3.1 Changes:
 * - ADDED: getDeviceCards() for state extraction (used by Main.syncDevicePanelToCache).
 * - CHANGED: clearDevices() no longer emits DEVICE_WINDOW_CHANGED internally.
 *   Reason: Prevents data loss during mode switch (Editor <-> Device).
 *   The [C] button now emits the event explicitly after clearing.
 * - Supports DeviceCard children.
 */
