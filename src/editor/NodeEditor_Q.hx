...
/**
* NODE EDITOR v4.4 (Visibility Fix – Double Redraw)
...
class NodeEditor extends Sprite
{
	...
	// =========================================================================
	// IMPULSYS LISTENERS (v4.5 FIX: Prevent anonymous function leak)
	// =========================================================================
	private var _onRedrawWires:Impulse -> Void;
	private var _onPortsChanged:Impulse -> Void;
	...
	public function new(assembly:Assembly)
	{
		...
		_onRedrawWires = function(_) _wireRenderer.rebuildAll();
		_onPortsChanged = function(_) { drawFrame(); _wireRenderer.rebuildAll(); };
		...
		// Subscribe using named references
		...
		Impulsys.subscribeToImpulse(EventType.ASSEMBLY_PORTS_CHANGED, _onPortsChanged);
	...
	*/
	...
	public function dispose():Void
	{
		...
		// Unsubscribe using the exact same references
		...
		Impulsys.removeImpulse(EventType.ASSEMBLY_PORTS_CHANGED, _onPortsChanged);
