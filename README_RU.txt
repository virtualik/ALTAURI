...
ALTAURUS - имя первого прототипа
...
└📁 Prog #[КОРНЕВАЯ ПАПКА ПРОЕКТА]
  ...
  | └📄 Window.as
  │
  └📁 Comm (будущие домены) #[ТУТ БУДЕТ РЕАЛИЗАЦИЯ ОТЛОЖЕННЫХ ЧАСТЕЙ ПРОЕКТА - МОДУЛЕЙ]
    ├📁 ATOM #[ТУТ БУДЕТ РЕАЛИЗАЦИЯ ДОМЕНА АТОМ]
    │ ├📁 Views #[ТУТ БУДЕТ РЕАЛИЗАЦИЯ ВИДОВ АТОМОВ]
    │ │ ├📄 Editor.as
    │ │ ├📄 Device.as
    │ ├📁 Behaviors #[ТУТ БУДЕТ РЕАЛИЗАЦИЯ АТОМОВ]
    │ │ └📄 ... .as
