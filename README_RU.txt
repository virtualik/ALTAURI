...
Идеальный интерфейс завтрашнего дня — это тот, который чувствуешь только тогда, когда он нужен.
Он предугадывает запрос, предлагает решение одним тапом, плавно ведет по сценарию и не грузит лишней информацией.
